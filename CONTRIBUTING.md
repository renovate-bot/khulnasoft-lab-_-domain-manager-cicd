...
issue](https://github.com/khulnasoft-lab/cpa-controller/issues) in this
...
request](https://github.com/khulnasoft-lab/cpa-controller/pulls), you will
...
```console
cd cpa-controller
pyenv virtualenv <python_version_to_use> cpa-controller
pyenv local cpa-controller
